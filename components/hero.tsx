...
export function Hero() {
  return (
    <section className="mx-auto w-full max-w-6xl px-5 pb-8 pt-8 md:px-8 md:pb-12 md:pt-16">
      <div className="overflow-hidden rounded-[2rem] border border-academy-line/10 bg-academy-card/[.04] shadow-glow">
        <div className="media-frame relative px-5 py-10 md:px-10 md:py-16">
          <div className="hero-scrim absolute inset-0" />
          <div className="relative max-w-3xl">
            <Badge tone="blue">Driven by Community</Badge>
            <h1 className="mt-5 text-4xl font-black leading-[.95] text-academy-foreground md:text-7xl">
            ...
            <p className="mt-7 text-sm font-bold text-academy-muted">
