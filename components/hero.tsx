  ...
  return (
    <section className="relative overflow-hidden border-b border-white/10 bg-[var(--ink)]">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-5 py-10 md:px-8 md:py-20">
        <div className="grid min-h-[560px] overflow-hidden rounded-[2rem] border border-white/10 bg-[rgba(255,255,255,.035)] shadow-[0_30px_90px_rgba(0,0,0,.35)] md:grid-cols-[1.18fr_.82fr]">
          ...
          <div className="relative min-h-80 border-t border-white/10 bg-[linear-gradient(180deg,#0b1a27,#07131f)] md:border-l md:border-t-0">
            <div className="absolute inset-x-8 top-8 h-48 rounded-full border border-academy-blue/35" />
            ...
            <div className="absolute bottom-6 left-6 right-6 rounded-3xl border border-white/12 bg-black/25 p-5 backdrop-blur">
